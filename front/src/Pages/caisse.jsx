...
function EtatCaisse() {
    ...
    const generatePDF = () => {
        ...
        // Add title
        doc.setFontSize(20);
        doc.text("Reglements List", 50, 20);

        // Add subtitle
        doc.setFontSize(12);
        doc.text("Detailed reglements report", 50, 28);
        ...
        // Add table
        const headers = ["Date de Reglement", "Police", "Nom Assure", "Montant Reglement", "Type Reglement"];
        const data = paginatedReglements().map(item => [
        ...
        doc.autoTable({
            head: [headers],
            body: data,
            startY: 50, // Adjusted to account for title
            theme: 'grid',
            styles: { textColor: [44, 62, 80], font: 'helvetica', fontStyle: 'bold' },
            columnStyles: { 0: { cellWidth: 'auto' } }
        });

        doc.save("reglements_list.pdf");
    };
                ...
                <div class="bg-white shadow-md w-11/12 rounded-lg p-6 mr-12">
                    <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button
                                class="py-2 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-700"
                                onClick={generatePDF}
                            >
                                Generate PDF
                            </button>
                    ...
                    <div id="reglements-list" class="styled-scrollbar">
